...
The skill continuously monitors token prices and sends notifications through the user's configured OpenClaw channel (Telegram, Discord, etc).
...
The skill should recognize all of the following as alert requests.
...
trading notification, market tracking
